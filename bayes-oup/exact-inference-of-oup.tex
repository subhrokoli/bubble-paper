...
\documentclass[english,aps, onecolumn, pre,superscriptaddress, notitlepage]{revtex4-1}
...
non-Bayesian methods.\\\\\textbf{\textcolor{black}{\large{}Ornstein-Uhlenbeck
process.}}\textbf{\textcolor{teal}{\Large{} }}\textbf{\label{sec:Ornstein-Uhlenbeck-process}}The
...
$k$ alone. We now describe these two methods.\\\\\textbf{\textcolor{black}{\large{}Bayesian
inference. }}\label{sec:Bayesian-inference} Consider, now, the time
...
\begin{figure}[t]
\includegraphics[scale=0.27]{srep/figure1}\caption{Schematic of balanced detection scheme to measure Brownian motion
...
\end{figure}
\\\\\textbf{\textcolor{black}{\large{}Experimental setup and data
acquisition. \label{sec:Experimental-setup-and}}}We collect position
...
\begin{figure*}[t]
\includegraphics[scale=0.66]{srep/figure2}
...
\end{figure*}
\\\\\textbf{\large{}Results and discussions.}\textbf{ \label{sec:Results}}We
now present our results. In Figure. (\ref{fig:discrete-sample-path})
...
of 300K which is the the same as the lab environment temperature -
...
\begin{figure}[t]
\includegraphics[width=0.74\textwidth]{srep/figure3}
...
``response'' methods that impose an external shear flow.} \\\\\textbf{\textcolor{black}{\large{}Conclusion}}.
...
\end{table*}
\begin{table*}
\begin{tabular}{>{\centering}m{2cm}>{\centering}p{2cm}>{\centering}p{2.5cm}>{\centering}p{1cm}}
\cmidrule{1-3} 
Laser power
...
\cmidrule{1-3} 
 & (a) &  & \tabularnewline
\end{tabular}%
\begin{tabular}{>{\centering}m{2cm}>{\centering}p{2cm}>{\centering}p{2.5cm}}
\toprule 
...
lengths for the same particle trapped at the same laser power. }
\end{table*}
\begin{table}
...
increasing glycerol concentration. The variance of mean is indicated
in parentheses. \label{tab:viscometry}}
\end{table}
\\\\\textbf{\textcolor{black}{\large{}Acknowledgements}}\\RA expresses
his gratitude, long overdue, to Professor M. E. Cates for introducing
him to Bayesianism.\\\\\textbf{\textcolor{black}{\large{}Author contributions}}\\SB
and SP contributed equally to this work - SB worked on the theoretical
...
research and wrote the paper.\\\\\textbf{\textcolor{black}{\large{}Additional
information}}\\Competing financial interests: The authors declare
no competing financial interests.\\\\\textbf{\textcolor{black}{\large{}Appendix\\}}The
first partial derivatives of the logarithm of the posterior probability
...
Eq.(\ref{eq:map-estimate}). The second partial derivatives, appearing
in Eq.(\ref{eq:quadratic-form}), are 
\begin{alignat*}{1}
