...
\begin{figure}
\centering \includegraphics[width=0.48\textwidth]{fig1} \caption{A schematic diagram of the experimental setup. TL1: trapping laser
...
\begin{figure*}
\centering \includegraphics[width=0.99\textwidth]{fig2} \caption{Verification of the fluctuation-response relation $C_{ij}=(k_{B}T/\pi f)\,\text{Im}(\chi_{ij}^{||})$
...
\begin{figure}
\centering \includegraphics[width=0.46\textwidth]{fig3} \caption{Amplitude and phase response for driven (B2) bead for different trap
...
\begin{figure}
\centering \includegraphics[width=0.48\textwidth]{fig1si} 
