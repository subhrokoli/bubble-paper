...
\pacs{PACS numbers: 83.10.Mj, 87.80.Cc, 83.10.Pp, 83.85.Vb}
...
\begin{figure}
\centering \includegraphics[width=0.45\textwidth]{fig1} \caption{A schematic diagram of the experimental setup. TL1: trapping laser
...
\begin{figure*}
\centering \includegraphics[scale=0.6]{fig2} \caption{Verification of the fluctuation-response relation $C_{ij}=(k_{B}T/\pi f)\chi_{ij}^{\prime\prime}$
...
a resonance frequency of around 111 Hz (blue solid spheres in Fig.\ref{response}(c))
...
\ref{response}(e) is easily explained: B2 lags 90 degrees in phase
