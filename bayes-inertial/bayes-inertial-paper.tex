...
\newblock A bayesian comparison of different classes of dynamic models using
  empirical data.
\newblock {\em IEEE Transactions on Automatic Control}, 22(5):715--727, 1977.

\bibitem{mackay1992bayesian}
D.~J.~C. MacKay.
\newblock Bayesian interpolation.
\newblock {\em Neural computation}, 4:415--447, 1992.
...
\newblock In {\em 37th meeting of the Society of Exploration Geophysicists,
  Oklahoma City 1967}, 1967.

\bibitem{berg2004power}
K.~Berg-S{\o}rensen and H.~Flyvbjerg.
\newblock Power spectrum analysis for optical tweezers.
\newblock {\em Review of Scientific Instruments}, 75(3):594--612, 2004.
...
\newblock {\em New Journal of Physics}, 14(11):115032, 2012.
